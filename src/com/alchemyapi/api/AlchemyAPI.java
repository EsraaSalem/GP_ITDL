...
public class AlchemyAPI {
	...
	static public AlchemyAPI GetInstanceFromFile(String keyFilename) throws FileNotFoundException, IOException {
...
//Yasmin key:7b18e56cf9fa7a645b58772b3417c73a15c511ba
	...
	public Document TextGetRankedConcepts(String text, AlchemyAPI_ConceptParams params)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
		CheckText(text);
	...
	public Document HTMLGetConstraintQuery(String html, String url, String query,
			AlchemyAPI_ConstraintQueryParams params)
					throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		CheckHTML(html, url);
		if (null == query || query.length() < 2)
			throw new IllegalArgumentException("Invalid constraint query specified");
	...
	public Document URLGetTargetedSentiment(String url, String target, AlchemyAPI_TargetedSentimentParams params)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
		CheckURL(url);
		CheckText(target);
	...
	public Document TextGetTargetedSentiment(String text, String target, AlchemyAPI_TargetedSentimentParams params)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
		CheckText(text);
		CheckText(target);
	...
	public Document URLGetCombined(String url)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
	...
	public Document URLGetTaxonomy(String url)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
	...
	public Document URLGetImage(String url)
			throws IOException, SAXException, ParserConfigurationException, XPathExpressionException {
