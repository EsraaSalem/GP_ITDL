...
public class FacebookPost {
	...
	public String toString() {
		return "FacebookPost [userID=" + userID + ", postID=" + postID + ", postContent=" + postContent
				+ ", creationDate=" + creationDate + ", read=" + read + "]";
	}
		...
		for (Entity entity : pq.asIterable()) {
			if (entity.getProperty("PostID").toString().equals(postID)) {
				FacebookPost returnedPost = new FacebookPost(entity.getProperty("UserID").toString(),
						...
						entity.getProperty("CreationDate").toString(),
						Integer.parseInt(entity.getProperty("Read").toString()));
				return returnedPost;
			}
		}
		return null;
